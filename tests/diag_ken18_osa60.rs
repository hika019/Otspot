...
#[test]
#[ignore = "known failing: obj 誤差 5.2% > 5% (LP perf regression); remove ignore when #75 phase X lands"]
...
#[test]
#[ignore = "known failing: postsolve cleanup_lp deadline (wall 72s > 60s); remove ignore when #75 phase X lands"]
